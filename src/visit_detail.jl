...
visit_detail(match...) = begin
    ...
    left_join(concept => concept(),
              visit_detail_concept_id == concept.concept_id, optional=true)
    left_join(type_concept => concept(),
              visit_detail_type_concept_id == concept.concept_id, optional=true)
    left_join(source_concept => concept(),
              visit_detail_source_concept_id == concept.concept_id, optional=true)
